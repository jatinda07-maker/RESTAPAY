...
if (!expenses.includes('dedupeVendorOptions') && !expenses.includes("slice().sort((a,b)=>alpha(a.name,b.name))")) throw new Error('Expense vendor dropdown is not sorted/de-duplicated A-Z')
