-- RESTAPAY SUPABASE RESET + CLOUD SYNC TABLES
-- Run this in Supabase Dashboard -> SQL Editor -> New Query -> Run.
-- WARNING: This deletes old RESTAPAY tables listed below.
...
drop table if exists public.payroll_group_members cascade;
...
-- Main RESTAPAY cloud-sync table used by the current React app.
...
-- Structured tables for future Supabase-native reporting/querying.
...
-- TEMP DEVELOPMENT ACCESS.
-- This lets the browser app read/write with your Supabase anon key.
-- Later, turn RLS back on and add proper user authentication policies.
