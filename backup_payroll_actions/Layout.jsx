...
const subtitles = {
  ...
  'approved-payroll': 'Review, edit, and finalize approved employee payroll',
...
export default function Layout({ active, setActive, children }) {
  ...
  const approvedPayrollItem = ['approved-payroll', 'Approved Payroll']
  const getNavItem = key => navItems.find(([itemKey]) => itemKey === key) || (key === 'approved-payroll' ? approvedPayrollItem : null)
  const activeItem = getNavItem(active)
