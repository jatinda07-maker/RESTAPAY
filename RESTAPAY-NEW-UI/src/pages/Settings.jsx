...
const cards=[
  ...
  {title:'Data & Backup',value:'Ready',meta:'Supabase connection later',tone:'green',icon:Database},
  {title:'Notifications',value:'Enabled',meta:'Imports and payroll alerts',tone:'orange',icon:Bell},
]
export default function Settings(){
  const[drawer,setDrawer]=useState(null),[tab,setTab]=useState('Business');const {notify}=useFeedback()
