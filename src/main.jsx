...
const Employees = lazy(() => import('./pages-v2/EmployeesV2'))
const Payroll = lazy(() => import('./pages-v2/PayrollV2'))
const Vendors = lazy(() => import('./pages-v2/VendorsV2'))
const VendorComparison = lazy(() => import('./pages-v2/VendorComparisonV2'))
const Invoices = lazy(() => import('./pages-v2/InvoicesV2'))
const Settings = lazy(() => import('./pages/Settings'))
const Sales = lazy(() => import('./pages-v2/SalesV2'))
const Reports = lazy(() => import('./pages/Reports'))
const Expenses = lazy(() => import('./pages-v2/ExpensesV2'))
