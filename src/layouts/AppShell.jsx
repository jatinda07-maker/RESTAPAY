...
export default function AppShell() {
  ...
  return <div className="app-shell" onPointerDownCapture={openDatePicker} onClickCapture={handleFallback}><Sidebar/><div className="app-main"><Topbar/><main className="page-canvas"><RouteAccess><Outlet/></RouteAccess></main></div></div>
}
